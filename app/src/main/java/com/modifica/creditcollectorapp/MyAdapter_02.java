...
public class MyAdapter_02 extends ArrayAdapter<String> {
    ...
    public MyAdapter_02(Context context, ArrayList<String> T11, ArrayList<String> T21, ArrayList<String> T31, ArrayList<String> T41){
        super((Context) context,R.layout.due_list,R.id.textView_LN,T11);
        this.T1Array=T11;
        this.T2Array=T21;
        this.T3Array=T31;
        this.T4Array=T41;
    ...
    public View getView(int position, View convertViwe, ViewGroup parent){
        ...
        View row = inflater.inflate(R.layout.due_list,parent,false);
